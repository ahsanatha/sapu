...
import { configurationsColumns as columns } from './configurations-columns'
...
export function ConfigurationsTable({ data, search, navigate }: DataTableProps) {
  ...
  const categoryOptions = useMemo(() => {
    ...
    for (const c of data) {
      if (c.category && c.category.trim() !== '') s.add(c.category)
    }
  ...
  return (
    <div className={cn('max-sm:has-[div[role="toolbar"]]:mb-16', 'flex flex-1 flex-col gap-4')}>
      <DataTableToolbar
        table={table}
        searchPlaceholder='Filter configurations...'
        searchKey='key'
        filters={[
