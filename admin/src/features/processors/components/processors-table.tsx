...
import { processorsColumns as columns } from './processors-columns'
...
export function ProcessorsTable({ data, search, navigate }: DataTableProps) {
  ...
  const typeOptions = useMemo(() => {
    ...
    for (const p of data) {
      if (p.type && p.type.trim() !== '') s.add(p.type)
    }
